...
export class SqliteStore implements GraphStore {
  ...
  nodeCount(): number {
    const row = this.stmt('SELECT COUNT(*) as count FROM nodes').get() as {
      count: number;
    };
    return row.count;
  }
  ...
  edgeCount(): number {
    const row = this.stmt('SELECT COUNT(*) as count FROM edges').get() as {
      count: number;
    };
    return row.count;
  }
  ...
  embeddingCount(): number {
    const row = this.stmt('SELECT COUNT(*) as count FROM embeddings').get() as {
      count: number;
    };
    return row.count;
  }
  ...
  episodeCount(): number {
    const row = this.stmt('SELECT COUNT(*) as count FROM episodes').get() as {
      count: number;
    };
    return row.count;
  }
  ...
  procedureCount(): number {
    const row = this.stmt('SELECT COUNT(*) as count FROM procedures').get() as {
      count: number;
    };
    return row.count;
  }
